...
// --- The following is with search, determine if delete later
/*import React, { useState, useEffect } from 'react';
import Badge from 'react-bootstrap/Badge';
import NavBar from "../navigation/Navigation";
import 'bootstrap/dist/css/bootstrap.min.css';
...
const CreateWorkout = () => {
    ...
    const filteredExercises = workoutCards.filter(exercise =>
        exercise.exercise_name.toLowerCase().includes(searchTerm.toLowerCase())
    );

    const tooltip = <Tooltip>Add exercises for the community.</Tooltip>;
        ...
        <div style={{ backgroundColor: '#F3F3F3' }}>
            ...
            <main className='Container'>
                <div className="row justify-content-center gap-4" style={{ padding: '40px' }}>
                    ...
                    {/!*--- Display generated workout cards with search functionality ---*!/}
                    <div className="card mb-4 col-lg-8 col-md-8 col-sm-8 col-8 border border-3" >
                        <div className="card-body">
                            <h3 className="card-title mb-3 fw-bold" style={{ marginTop: '20px' }}>Community Exercises</h3>
                            <p>Below is a list of exercises that were created by our community.</p>
                            {/!* Search bar *!/}
                            <div className="mb-3">
                                {/!*<label htmlFor="searchTerm" className="form-label">Search Exercises:</label>*!/}
                                <input
                                    type="text"
                                    id="searchTerm"
                                    className="form-control"
